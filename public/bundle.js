...
store.dispatch((0, _bookActions.deleteBook)({ id: 1 }));
...
function booksReducers() {
  ...
  switch (action.type) {
    ...
    case "update_book":
      ...
      var bookToUpdate = _extends({}, currentBookToUpdate[indexToUpdate], {
        title: action.payload.title
      });
      console.log("update", bookToUpdate);

      return { books: [].concat(_toConsumableArray(currentBookToUpdate.slice(0, indexToUpdate)), [bookToUpdate], _toConsumableArray(currentBookToUpdate.slice(indexToUpdate + 1))) };
      break;
